...
namespace LearningSystem.web.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Category course = db.Courses.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,CategoryId")] Category course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,CategoryId")] Category course)
        {
            if (ModelState.IsValid)
            {
