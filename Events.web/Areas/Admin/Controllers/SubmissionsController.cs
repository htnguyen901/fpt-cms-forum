    ...
    public class SubmissionsController : Controller
    {
        ...
        public JsonResult DashBoardcounts()
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("select count(CONVERT(date, ClosureDate)) as date,(select count(CONVERT(date, ClosureDate)) from Submissions where ClosureDate like '%2021%') as closuredate from Submissions where ClosureDate like '%2022%'", con);
